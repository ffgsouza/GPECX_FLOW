  ...
  useEffect(() => {
    if (product) {
      form.reset({
        ...
        finalSellPriceBRL: product.finalSellPriceBRL || 0,
        imageUrl: product.imageUrl || "",
        isSoftwarePisCofinsFree: product.isSoftwarePisCofinsFree || false,
              ...
              <div className="flex gap-6 items-start">
                ...
                <div className="flex-shrink-0 w-[250px]">
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>Link da Imagem (Firestore)</FormLabel>
                        <FormControl>
                          <Input placeholder="https://..." {...field} />
                        </FormControl>
                        <FormMessage />
                        {field.value && (
                          <div className="mt-2 text-xs text-center border rounded p-1 bg-slate-50">
                            <img src={field.value} alt="Preview" className="h-20 mx-auto object-contain mix-blend-multiply" />
                          </div>
                        )}
                      </FormItem>
                    )}
        ...
        <TableBody>
          {products.map((product) => (
            <TableRow key={product.id}>
              ...
              <TableCell>
                <span
                  className={`px-2 py-1 text-xs rounded-full ${getProductTypeName(product.productTypeId) === 'Hardware'
